            ...
            <ul class="wppayform_sidebar_list_v2" style="margin-top: 0px;">
                <li class="wpf_global_setting_component <?php echo esc_attr(Helper::getHtmlElementClass('settings', $currentComponent)); ?>">
                    ...
                    <div class="wpf_setting_title">
                        <?php echo '<img src="' . esc_url($assetUrl) . 'form/settings.svg" />'; ?>
                        <p>
                            <?php echo esc_html__('General Settings') ?>
                        </p>
                    </div>
                    <div class="wpf_setting_forward_icon">
                        <?php echo '<img src="' . esc_url($assetUrl) . 'global/forward.svg" />'; ?>
                    </div>
                    </a>
                </li>
                <?php foreach ($components as $componentName => $component): ?>
                    <li class="wpf_global_setting_component <?php echo esc_attr(Helper::getHtmlElementClass($component['hash'], $currentComponent)); ?> wppayform_item_<?php echo esc_attr($componentName); ?>" data-wppayform-settings-list="">
                        <a data-settings_key="<?php echo esc_attr(Arr::get($component, 'settings_key')); ?>"
                            ...
                            <div class="wpf_setting_title">
                                ...
                                ?>
                                <p>
                                    <?php echo esc_html__($component['title']) ?>
                                </p>
                            </div>
                            <div class="wpf_setting_forward_icon">
                            <?php echo '<img src="' . esc_url($assetUrl) . 'global/forward.svg" />'; ?>
