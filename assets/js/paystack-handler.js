...
/***/ "./resources/public/paystack_handler.js":
/*!**********************************************!*\
  !*** ./resources/public/paystack_handler.js ***!
  \**********************************************/
/*! no exports provided */
...
var PaystackHandler = /*#__PURE__*/function () {
  function PaystackHandler($that, config) {
    _classCallCheck(this, PaystackHandler);
    this.$form = $that.form;
  ...
  _createClass(PaystackHandler, [{
    key: "init",
    value: function init() {
      var _this = this;
      this.$form.on('wppayform_next_action_paystack', function (event, data) {
        var response = data.response;
        jQuery('<div/>', {
          'id': 'form_success',
          'class': 'wpf_form_notice_success wpf_paystack_text'
        }).html(response.data.message).insertAfter(_this.$form);
        if (response.data.actionName === 'initPaystackModal') {
          _this.initPaystackModal(response.data);
        } else {
    ...
    key: "initPaystackModal",
    value: function initPaystackModal(res) {
      var that = this;
      var options = res.modal_data;
      options.callback = function (response) {
        var data = _objectSpread({
          action: 'wppayform_paystack_confirm_payment',
          form_id: that.formId
        }, response);
        that.$form.parent().find('.wpf_paystack_text').remove();
...
(function ($) {
  $.each($('form.wppayform_has_payment'), function () {
    ...
    $form.on('wppayform_init_single', function (event, $that, config) {
      new PaystackHandler($that, config).init();
    });
  });
})(jQuery);
...
/***/ 9:
/*!****************************************************!*\
  !*** multi ./resources/public/paystack_handler.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Volumes/projects/wordpress/wp-content/plugins/wp-payment-form/resources/public/paystack_handler.js */"./resources/public/paystack_handler.js");
