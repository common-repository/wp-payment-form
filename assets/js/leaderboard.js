...
/***/ "./resources/public/leaderboard-template/template_1.js":
/*!*************************************************************!*\
  !*** ./resources/public/leaderboard-template/template_1.js ***!
  \*************************************************************/
/*! no exports provided */
...
/* harmony import */ var core_js_modules_es7_object_entries_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! core-js/modules/es7.object.entries.js */ "./node_modules/core-js/modules/es7.object.entries.js");
/* harmony import */ var core_js_modules_es7_object_entries_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_object_entries_js__WEBPACK_IMPORTED_MODULE_9__);
...
jQuery(document).ready(function ($) {
  var sortKey = $('.wpf-user').attr('data-orderby');
  var sortType = true;
  var searchText = '';
  var form_id = $('.wpf-user').attr('data-form_id');
  var template_id = $('.wpf-donor-card-wrapper').attr('data-template');
  var perPage = $('.wpf-user').attr('data-per-page');
  var loadData = parseInt(perPage);
  var timeOut = null;
  var nodonorImage = window.wp_payform_leader_board.no_donor_image;
  console.log('nodonorImage.......', nodonorImage);
  var showName = $('.wpf-template-wrapper').attr('data-show-name');
  var showAvatar = $('.wpf-template-wrapper').attr('data-show-avatar').replace(/\s/g, '');
  var showTotal = $('.wpf-template-wrapper').attr('data-show-total').replace(/\s/g, '');
  $('.wpf-search-input').keyup(function () {
    searchText = $(this).val();
    clearTimeout(timeOut);
    timeOut = setTimeout(function () {
      getDonationList(searchText, sortKey, sortType, loadData);
    }, 1000);
  });
  $('.wpf-load-more').click(function () {
    loadData = +loadData + +perPage;
    $(this).text('Loading...');
    getDonationList(searchText, sortKey, sortType, loadData);
  });
  $('.wpf-radio-button').click(function () {
    var sortKey = $(this).attr('data-sort-key');
    var sortType = $(this).attr('key_value');
    getDonationList(searchText, sortKey, sortType, loadData);
  });
  function getDonationList(searchText, sortKey, sortType, perPage) {
    $('.wpf-user').css('opacity', 0.4);
    $('.wpf-leaderboard-loader span').attr('class', 'loader show');
    jQuery.post(window.wp_payform_leader_board.ajax_url, {
      action: 'wpf_leader_board_render',
      ...
      response.data.has_more_data ? $('.wpf-load-more').removeClass('disabled') : $('.wpf-load-more').addClass('disabled');
      $('.wpf-user').css('opacity', 1);
      $('.wpf-leaderboard-loader span').attr('class', 'loader hide');
      $('.wpf-load-more').text('Load More');
      if (template_id == 'template_3') {
        renderTemplateThree(response);
      } else {
        renderData(response);
      }
    });
  }
  function renderTemplateThree(response) {
    var parentUser = $('.wpf-user');
    parentUser.empty();
    var load_more = $('.wpf-leaderboard-load-more-wrapper')[0];
    if (response.data.donars.length === 0) {
      var isNoDonorFoundElementExist = $('.wpf-no-donor-found').length;
      if (isNoDonorFoundElementExist) {
        return;
      }
      var user = "\n                <div class=\"wpf-no-donor-found\">\n                    <img src=\" ".concat(nodonorImage, " \" alt=\"No Donor Found\" class=\"wpf-no-donor-found-image\" style=\"width: 280px\">\n                    <p style=\"background: inherit; color: #000; size: 20px;\">No donor found!</p>\n                </div>\n                ");
      parentUser.append(user);
      load_more.style.display = 'none';
    }
    for (var _i = 0, _Object$entries = Object.entries(response.data.donars); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
        key = _Object$entries$_i[0],
        value = _Object$entries$_i[1];
      var _user = "\n                <div class=\"wpf-donor-list three\">\n                ".concat(showAvatar == 'true' ? "\n                    <div class=\"wpf-donor-image\">\n                        <img src=\"https://secure.gravatar.com/avatar/".concat(value.customer_email, "?s=96&amp;d=mm&amp;r=g\" alt=\"User Avatar\">\n                    </div>\n                ") : '', "\n        \n                <div class=\"wpf-donor-info\">\n                    ").concat(showName == 'true' ? "\n                        <div class=\"wpf-donor-name three\">\n                            <h3>".concat(value.customer_name, "</h3>\n                        </div>\n                    ") : '', "\n        \n                    ").concat(showTotal === 'true' ? "\n                        <div class=\"wpf-donor-amount three\">\n                            <p>Donation Amount</p>\n                            <span>".concat(value.currency).concat(value.grand_total, "</span>\n                        </div>\n                    ") : '', "\n                </div>\n            </div>\n                ");
      parentUser.append(_user);
  ...
  function renderData(response) {
    ...
    var donarIndex = 0;
    for (var _i2 = 0, _Object$entries2 = Object.entries(response.data.donars); _i2 < _Object$entries2.length; _i2++) {
      var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2),
        key = _Object$entries2$_i[0],
        value = _Object$entries2$_i[1];
      console.log(value);
      var dateObject = value.created_at;
      var formattedDate = new Date(dateObject.date + dateObject.timezone).toLocaleString('en-GB', {
        day: '2-digit',
        month: 'short',
        year: 'numeric'
      }).replace(',', '');
      var _user2 = "<div class=\"wpf-user-row ".concat(form_id === '' ? 'wpf-all-forms-user' : '', "\">\n                    <div class=\"wpf-user-serial\">\n                        <span class=\"wpf-user-serial-text\">").concat(++donarIndex, "</span>\n                    </div>\n                    \n                    <div class=\"wpf-user-avatar-name\">\n                        ").concat(showAvatar == 'true' ? "\n                        <div class=\"wpf-user-avatar\">\n                            <img src=\"https://secure.gravatar.com/avatar/".concat(value.customer_email, "?s=96&amp;d=mm&amp;r=g\" alt=\"User Avatar\">\n                        </div>\n                        ") : '', "\n                        ").concat(showName == 'true' ? "\n                        <div class=\"wpf-user-name\">\n                            <span class=\"wpf-user-name-text\">".concat(value.customer_name, "</span>\n                        </div>\n                        ") : '', "\n                    </div>\n\n                    ").concat(showName == 'true' ? "\n                        <span class=\"wpf-user-name-text\">\n                            <span class=\"wpf-user-name-text\">".concat(formattedDate, "</span>\n                        </span>\n                        ") : '', "\n                    ").concat(showName == 'true' ? "\n                        ".concat(form_id ? "\n                            <span class=\"wpf-user-donations\">".concat(value.donations_count, " Donations </span>\n                        ") : '', "\n                    ") : '', "\n\n                    ").concat(showName == 'true' ? "\n                    <div class=\"wpf-user-amount\">\n                        <span class=\"wpf-user-amount\">\n                            <span class=\"wpf-text-currency\">".concat(value.currency, "</span>\n                            <span class=\"wpf-text-amount\">").concat(value.grand_total, "</span>\n                        </span>\n                    </div>\n                    ") : '', "\n                </div>");
      parentUser.append(_user2);
      load_more.style.display = 'block';
    }
  }
  ;
...
/***/ 6:
/*!*******************************************************************!*\
  !*** multi ./resources/public/leaderboard-template/template_1.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Volumes/projects/wordpress/wp-content/plugins/wp-payment-form/resources/public/leaderboard-template/template_1.js */"./resources/public/leaderboard-template/template_1.js");
